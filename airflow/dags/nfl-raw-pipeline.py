...
def nfl_raw_pipeline():
    ...
    @task
    def schema():
        url = "https://us-central1-bjwilcox-ba882-fall25.cloudfunctions.net/raw-schema-setup"
    ...
    def extract(payload:dict) -> dict:
        url = "https://us-central1-bjwilcox-ba882-fall25.cloudfunctions.net/raw-extract-scoreboard"
    ...
    def load(payload:dict) -> dict:
        url = "https://us-central1-bjwilcox-ba882-fall25.cloudfunctions.net/raw-load-scoreboard"
        ctx = get_current_context()
